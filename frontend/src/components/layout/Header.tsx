    ...
    return (
        <header className="h-20 bg-obsidian-900/30 backdrop-blur-xl border-b border-glass-border flex items-center justify-between px-8 z-20">
            <div className="flex items-center gap-8 flex-1">
                {/* Global Market Ticker (Integrated into Search) */}
                ...
                <div className="hidden lg:flex items-center gap-6">
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-sm font-mono font-black text-white">22,345.65</span>
                            <span className="text-[10px] font-bold text-trading-profit neon-glow-profit">+0.42%</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-sm font-mono font-black text-white">73,452.12</span>
                            <span className="text-[10px] font-bold text-trading-loss neon-glow-loss">-0.12%</span>
                        </div>
                    </div>
                </div>
            </div>
